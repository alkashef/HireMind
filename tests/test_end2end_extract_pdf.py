...
# Removed: local Hermes extraction test. Project uses OpenAI-only.


# Removed: local paraphrase embedding test. Project uses OpenAI embeddings/Weaviate-native vectors.
